 ...
 * @LastEditors  : ranli
 * @LastEditTime : 2020-01-10 21:13:51
 -->
<template>
  <div ref="add">
                      ...
                      <el-form-item label
                        ...
                        <div v-if="baseFrom.person.have=='是'"
                          ...
                          <el-form-item label="吸烟多少年？"
                            prop="smoking_year">
                            <el-input size="mini"
                              v-model.trim="baseFrom.person.smoking_year"></el-input><span> &nbsp;年</span>
                          </el-form-item>
                          <el-form-item label="每天吸烟多少支？"
                            prop="smoking_num">
                            <el-input size="mini"
                              v-model.trim="baseFrom.person.smoking_num"></el-input><span> &nbsp; 支</span>
                          </el-form-item>
                        </div>
                      </el-form-item>
                    </div>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        age: [validate.verifyRequired("请输入年龄")],
      ...
      stepOne: [
        ...
        },
        {
          ...
          type: "select",
          maxLength: "20",
          options: selectData.sexTypeData
        },
        {
          label: "生日",
          valueKey: "birthday",
  ...
  created() {
    this.baseFrom.person_user_id = this.getActiveUser.person_user_id;
    this.$nextTick(() => {
      this.resetForm("baseFrom");
    });
